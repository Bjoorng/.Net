            ...
            do
            {
                ...
                switch (choice.ToUpper())
                {
                    case "I":
                        ...
                        {
                            stud.Subjects.Add(dbContext.Subjects.Find(int.Parse(id)));
                        }
                        dbContext.Add(stud);
                        dbContext.SaveChanges();
                        break;
                    case "C":
                        ...
                        do
                        {
                            ...
                            foreach (Student student in studentsEdit)
                            {
                                ...
                                Console.WriteLine("Subjects: ");
                                student.Subjects.ForEach(e => Console.WriteLine($"{e.Name}"));
                            ...
                            else
                            {
                                ...
                                if (studentById != null)
                                {
                                    ...
                                    List<Subject> subjectsEdit = dbContext.Subjects.ToList();
                                    subjectsEdit.ForEach(element => Console.WriteLine($"{element.Id} {element.Name}"));
                                    Console.WriteLine("Type the index of the new Subject You want to add!");
                                    ...
                                    else if (int.Parse(idEdit) < 1)
                                    {
                                        ...
                                        studentById.Subjects = studentById.Subjects;
                                    }
                                    else{
                                        ...
                                        if (subjectById!= null)
                                        {
                                            studentById.Subjects.Add(dbContext.Subjects.Find(subjectById));
